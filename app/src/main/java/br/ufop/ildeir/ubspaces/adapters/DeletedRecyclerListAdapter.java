...
public class DeletedRecyclerListAdapter extends RecyclerView.Adapter {
...
//    private SortedList<RecyclerViewItem> filteredItemsByName = new SortedList<RecyclerViewItem>(RecyclerViewItem.class, sortedListCallback);
    ...
    public DeletedRecyclerListAdapter(Context context, ArrayList<RecyclerViewItem> itemList, MessageAdapterListener listener, OnLoadMoreListener onLoadMoreListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.deleted_object_list_adapter, parent, false);
