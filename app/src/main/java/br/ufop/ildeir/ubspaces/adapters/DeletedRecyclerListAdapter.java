...
public class DeletedRecyclerListAdapter extends RecyclerView.Adapter<DeletedRecyclerListAdapter.MyViewHolder> {
    ...
    public DeletedRecyclerListAdapter(Context context, ArrayList<RecyclerViewItem> itemList, RecyclerListAdapter.MessageAdapterListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.deleted_object_list_adapter,parent,false);
